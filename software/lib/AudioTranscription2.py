...
class AudioTranscription:
    def __init__(self, recording_device_name, target_sample_rate=16000):
        ...
        MODEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "vosk_model")
    ...
    def capture_and_transcribe(self):
        ...
        with sd.RawInputStream(samplerate=self.TARGET_SAMPLE_RATE, blocksize=8000, dtype="int16", 
...
if __name__ == "__main__":
    try:
        audio_transcription = AudioTranscription(recording_device_name="USB PnP Sound Device")
